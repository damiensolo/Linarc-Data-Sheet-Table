...
export const getDefaultSpreadsheetColumns = (): SpreadsheetColumn[] => [
    { id: 'name', label: 'Contract Line', width: 220, editable: true, visible: true },
    { id: 'remainingContract', label: 'Remaining Contract', width: 140, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'costCode', label: 'Cost Code', width: 90, editable: true, visible: true },
    { id: 'quantity', label: 'Qty', width: 60, align: 'right', editable: true, visible: true },
    { id: 'unit', label: 'UOM', width: 50, editable: true, visible: true },
    { id: 'effortHours', label: 'Hours', width: 60, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'totalBudget', label: 'Budget', width: 110, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'labor', label: 'Labor', width: 90, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'material', label: 'Material', width: 90, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'equipment', label: 'Equipment', width: 90, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'subcontractor', label: 'Sub', width: 90, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'others', label: 'Others', width: 80, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'overhead', label: 'Overhead', width: 90, align: 'right', isTotal: true, editable: true, visible: true },
    { id: 'profit', label: 'Profit', width: 90, align: 'right', isTotal: true, editable: true, visible: true },
];